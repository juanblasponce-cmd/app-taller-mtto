...
export default function Login() {
  ...
  useEffect(() => { api.get('/auth/usuarios').then(setUsuarios).catch(() => setUsuarios([])); }, []);

  const entrar = async (u) => { setBusy(true); try { await login(u); } finally { setBusy(false); } };
