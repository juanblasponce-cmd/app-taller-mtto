...
const MENU = [
  ...
  { grupo: 'Planificación' },
  { to: '/backlog', ico: '📚', label: 'Backlog', roles: ['supervisor', 'planificador', 'administrador', 'gestor_sap'] },
  { to: '/reportes', ico: '📈', label: 'Reportes', roles: ['supervisor', 'planificador', 'administrador'] },
  { grupo: 'Catálogos' },
